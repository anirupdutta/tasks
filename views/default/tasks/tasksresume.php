...
?>
				...
				<table width="100%" class="tasks" >
					<tr>
						...
						<?php $xt = elgg_view('output/text',array('value' => elgg_echo("tasks:task_type_{$vars['entity']->task_type}"))); 
						echo $xt;
	?>
						</td>
						<td width="33%">
            ...
            <?php } ?>
				...
				<table width="100%" class="tasks">
					<tr>
						...
						<td width="33%" style="text-align: right;">  
						<?php 
							$color = elgg_echo("tasks:color_percent_done_{$vars['entity']->percent_done}");
						?>
						...
						<b><?php 	echo elgg_echo('tasks:percent_done'); ?></div></b>
