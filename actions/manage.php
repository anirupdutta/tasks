<?php
	...
	action_gatekeeper();
		...
		$incentives = get_input('incentives');
		$incentivesdes = get_input('incentivesdes');
		...
		if(!empty($incentives)) {
			$entity->incentives = $incentives;
		}
		if(!empty($incentivesdes)) {
			$entity->incentivesdes = $incentivesdes;
		}
